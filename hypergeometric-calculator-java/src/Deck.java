...
public class Deck
{
    ...
    public Deck(final long popSize, final long popSuccesses, final long sampleSize, final long desiredSuccesses)
    {
        ...
        {
            System.out.println("The numbers you entered are not a valid hypergeometric distribution. Try again.");
            System.exit(1);
        }
    }
    ...
    // Prints the probabilities to the console
    public void print()
    {
        System.out.println("Chance of exactly desired successes: " + this.exactChance);
        System.out.println("Chance of less than desired successes: " + (this.orLessInclusiveChance - this.exactChance));
        System.out.println("Chance of desired successes or less: " + this.orLessInclusiveChance);
        System.out.println("Chance of greater than desired successes: " + (this.orGreaterInclusiveChance - this.exactChance));
        System.out.println("Chance of desired successes or greater: " + this.orGreaterInclusiveChance);
    }
}
